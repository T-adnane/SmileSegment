...
model_path = './models'
model_name = 'gencive_Mesh_Segementation_MeshSegNet_15_classes_18_samples_9000_patch_11_Epoch_6_aug_2_batch_best.tar'
...
def process_prediction(uploaded_file):
    ...
    with torch.no_grad():
        ...
        vedo.write(mesh2, os.path.join(output_path, '1.vtp'))
...
def download(uploaded_file):
    uploaded_file.save(os.path.join(mesh_path, '1.obj'))
    global sample_filenames
    sample_filenames = [uploaded_file.filename]
