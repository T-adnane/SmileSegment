...
if _name_ == '_main_':
    ...
    model_path = '/content/drive/MyDrive/MeshSegNetV1.0//models'
    model_name = 'Mesh_Segementation_MeshSegNet_15_classes_18_samples_8000_patch_10_Epoch_6_aug_best.tar'

    mesh_path = '/content/drive/MyDrive/MeshSegNetV1.0/inputs'  # need to modify
    sample_filenames = ['Sample_20.vtp'] # need to modify
    output_path = '/content/drive/MyDrive/MeshSegNetV1.0/outputs'
